...
from .views import register, user_login, index, user_logout, profile, post_job, job_details, recommended_jobs, apply, user_applied_jobs, employer_jobs, applications
